...
# --- Lobbyist registration data (FL Legislature Online Sunshine) ---
# Tab-delimited, 37 columns. Updated continuously.
LLOB_URL = "https://www.leg.state.fl.us/Lobbyist_DL/llob.txt"  # Legislative lobbyists
ELOB_URL = "https://www.leg.state.fl.us/Lobbyist_DL/elob.txt"  # Executive lobbyists
