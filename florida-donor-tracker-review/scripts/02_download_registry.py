...
# Extended back to 2006 for full 20-year history of FL state candidates.
# Hard money (direct-to-candidate) is tracked per election cycle — each
# election gets its own account, so we need all cycles to build a complete picture.
