...
export default function CommitteesList() {
  ...
  return (
    <div>
      {/* Committee type explainer — inline, always visible */}
      <div style={{
          ...
          <tbody>
            {pageItems.map((c, i) => (
              <tr key={c.acct_num} style={{ borderBottom: '1px solid rgba(100,140,220,0.06)' }}>
                ...
                <td style={{ padding: '0.4rem 0.6rem', textAlign: 'right', color: 'var(--orange)', fontWeight: 600, fontFamily: 'var(--font-mono)', fontSize: '0.82rem', whiteSpace: 'nowrap' }}>
