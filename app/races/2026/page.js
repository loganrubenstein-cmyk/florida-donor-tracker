            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '0.5rem' }}>
              {[
                ...
                <div key={s.label} style={{ display: 'flex', justifyContent: 'space-between', gap: '1rem', alignItems: 'baseline' }}>
                  ...
                  <span style={{ fontSize: '0.88rem', fontWeight: 700, color: 'var(--teal)', fontFamily: 'var(--font-mono)' }}>{s.val}</span>
                </div>
              ))}
            </div>
          </div>
              ...
              <Link href={`/candidate/${topRaiser.acct_num}`} style={{ textDecoration: 'none' }}>
                <div style={{
                  ...
                  <div>
                    ...
                    <div style={{ fontSize: '1.1rem', fontWeight: 700, color: 'var(--teal)', fontFamily: 'var(--font-mono)', marginBottom: '0.25rem' }}>
                  ...
                  <div style={{ textAlign: 'right' }}>
                    <div style={{ fontSize: '1.4rem', fontWeight: 700, color: 'var(--teal)', fontFamily: 'var(--font-mono)' }}>
