...
/**
 * Format a year range like "2018–2024".
 */
export function fmtYearRange(minYear, maxYear) {
  if (!minYear && !maxYear) return '';
  if (minYear === maxYear || !maxYear) return String(minYear || maxYear);
